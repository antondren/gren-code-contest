...
class BankTransactionServiceTest {
    private final BankTransactionService bankTransactionService = new BankTransactionService(new AccountRepositoryImpl());

    @Test
    void testProcessingOfTransactionsAndReportGenerating() {
        List<Account> report = bankTransactionService.processTransactionsAndGenerateReport(createTransactionsFromJson());
